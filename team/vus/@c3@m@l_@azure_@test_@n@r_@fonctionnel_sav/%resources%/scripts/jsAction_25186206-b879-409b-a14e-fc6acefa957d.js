var myClient = context.variableManager.getValue("list_client_product_quantity_Global_Test_NR.client");
if (myClient==null) {
...
else
{
        ...
        var myOrder = context.variableManager.getValue("list_client_product_quantity_Global_Test_NR.product_quantity");
        if (myOrder==null) {
        ...
        else
        {
                ...
                var myType = context.variableManager.getValue("list_client_product_quantity_Global_Test_NR.type");
                if (myType==null) {
                       context.fail(" Message type  not found, check input file");
                }
                
                var myAttendu = context.variableManager.getValue("list_client_product_quantity_Global_Test_NR.attendu_requete");
                if (myAttendu==null) {
                ...
                var myAttendu_ihm = context.variableManager.getValue("list_client_product_quantity_Global_Test_NR.attendu_IHM");
                if (myAttendu==null) {
