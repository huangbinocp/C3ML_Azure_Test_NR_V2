var myClient = context.variableManager.getValue("ListeClientProduit_NR_Demande_de_Dispo_301_quantite.client");
if (myClient==null) {
...
else
{
        ...
        var myOrder = context.variableManager.getValue("ListeClientProduit_NR_Demande_de_Dispo_301_quantite.product_quantity");
        if (myOrder==null) {
        ...
        else
        {
                ...
                var myType = context.variableManager.getValue("ListeClientProduit_NR_Demande_de_Dispo_301_quantite.type");
                if (myType==null) {
                       context.fail(" Message type  not found, check input file");
                }
                
                var myAttendu = context.variableManager.getValue("ListeClientProduit_NR_Demande_de_Dispo_301_quantite.attendu_requete");
                if (myAttendu==null) {
                ...
                var myAttendu_ihm = context.variableManager.getValue("ListeClientProduit_NR_Demande_de_Dispo_301_quantite.attendu_IHM");
                if (myAttendu==null) {
