var myClient = context.variableManager.getValue("ListeClientProduit_NR_CDE_DDD_Non_Abonne.client");
if (myClient==null) {
...
else
{
        ...
        var myOrder = context.variableManager.getValue("ListeClientProduit_NR_CDE_DDD_Non_Abonne.product_quantity");
        if (myOrder==null) {
        ...
        else
        {
                ...
                var myType = context.variableManager.getValue("ListeClientProduit_NR_CDE_DDD_Non_Abonne.type");
                if (myType==null) {
                       context.fail(" Message type  not found, check input file");
                }
                
                var myAttendu = context.variableManager.getValue("ListeClientProduit_NR_CDE_DDD_Non_Abonne.attendu_requete");
                if (myAttendu==null) {
                ...
                var myAttendu_ihm = context.variableManager.getValue("ListeClientProduit_NR_CDE_DDD_Non_Abonne.attendu_IHM");
                if (myAttendu==null) {
