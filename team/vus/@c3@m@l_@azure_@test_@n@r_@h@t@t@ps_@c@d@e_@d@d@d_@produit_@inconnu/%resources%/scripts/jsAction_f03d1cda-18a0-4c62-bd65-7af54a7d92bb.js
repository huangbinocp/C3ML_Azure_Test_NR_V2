var myClient = context.variableManager.getValue("list_client_product_quantity_NR_HTTPs_CDE_DDD_Produit_Inconnu.client");
if (myClient==null) {
...
else
{
        ...
        var myOrder = context.variableManager.getValue("list_client_product_quantity_NR_HTTPs_CDE_DDD_Produit_Inconnu.product_quantity");
        if (myOrder==null) {
        ...
        else
        {
                ...
                var myType = context.variableManager.getValue("list_client_product_quantity_NR_HTTPs_CDE_DDD_Produit_Inconnu.type");
                if (myType==null) {
                       context.fail(" Message type  not found, check input file");
                }
                
                var myAttendu = context.variableManager.getValue("list_client_product_quantity_NR_HTTPs_CDE_DDD_Produit_Inconnu.attendu_requete");
                if (myAttendu==null) {
                ...
                var myAttendu_ihm = context.variableManager.getValue("list_client_product_quantity_NR_HTTPs_CDE_DDD_Produit_Inconnu.attendu_IHM");
                if (myAttendu==null) {
